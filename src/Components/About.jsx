...
const ABOUT = () => {
  return (
    <div
      name="about"
      className="about w-full min-h-screen text-white bg-gradient-to-b from-gray-800 to-black"
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full abcon">
        ...
        <p className="text-xl mt-20">
          I'm a Full Stack Web Developer with expertise in the MERN stack (MongoDB, Express.js, React, and Node.js). I have a strong passion for creating dynamic, responsive, and user-friendly web applications.
        </p>
        <br />
        <p className="text-xl">
