...
const Experience = () => {
  const techs = [
    ...
    { id: 4, src: BOOT, title: 'BOOTSTRAP', style: 'shadow-purple-500' },
    { id: 5, src: WIND, title: 'TAILWIND', style: 'shadow-sky-400' },
    { id: 6, src: REACTJS, title: 'REACTJS', style: 'shadow-blue-700' },
    { id: 7, src: NODEJS, title: 'NODEJS', style: 'shadow-green-500' },
    { id: 8, src: EXPRESS, title: 'EXPRESSJS', style: 'shadow-white' },
    { id: 9, src: MONGO, title: 'MONGODB', style: 'shadow-green-700' },
  ];

  return (
    <div
      name="experience"
      className="experience bg-gradient-to-b from-gray-800 to-black w-full min-h-screen"
    >
      <div className="max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full text-white">
        ...
        <div className="exp_container w-full grid grid-cols-2 sm:grid-cols-3 gap-8 text-center py-8 px-12">
          {techs.map(({ id, src, title, style }) => (
            <div
              key={id}
              className={`shadow-md hover:scale-105 duration-500 exp py-2 rounded-lg ${style}`}
            >
